...
Our work also requires some supplementary packages such as ``Wordnet" database and ``WS4J" library. We use the the latest released version for linux-Wordnet 3.0 from http://wordnet.princeton.edu/wordnet/ download/current-version/. We compute the similarity metrics by utilizing WS4J library from https://code. google.com/p/ws4j/.
